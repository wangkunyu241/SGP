...
from .our_vit import create_model as create_model_mae
...
linf = OrderedDict(
    [
        ...
        ('Standard_VITB', {
            'model': lambda: timm.create_model("vit_base_patch16_224", pretrained=True),
            'gdrive_id': '',
            'preprocessing': 'Res256Crop224'
        }),
    ])
...
common_corruptions = OrderedDict(
    [
        ...
        ('Standard_VITB', {
            'model': lambda: timm.create_model("vit_base_patch16_224", pretrained=False, checkpoint_path="../../resource/vit_base_patch16_224.augreg_in21k_ft_in1k/pytorch_model.bin"),
            'gdrive_id': '',
            'preprocessing': 'Res256Crop224'
        })
    ])
