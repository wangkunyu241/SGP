...
common_corruptions = OrderedDict([
    ...
    ('Standard_VITB', {
        'model': lambda: modify_head(timm.create_model("vit_base_patch16_384", pretrained=False, checkpoint_path="../../resource/vit_base_patch16_384.augreg_in21k_ft_in1k/pytorch_model.bin")),
        'gdrive_id': '',
    }),
