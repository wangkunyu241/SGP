...
def evaluate(description):
    ...
    checkpoint = torch.load("../../resource/vit_base_384_cifar10.t7")
    new_state_dict = {}
...
def setup_pruning(model):
    model = pruning_10c.configure_model(model)
    params, param_names = pruning_10c.collect_params(model)
    optimizer = setup_optimizer(params)
    pruning_model = pruning_10c.Pruning(model, optimizer,
