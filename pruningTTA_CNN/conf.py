...
# Data directory
_C.DATA_DIR = "../resource"

# Weight directory
_C.CKPT_DIR = "../resource"
...
# --------------------------------- Pruning options ----------------------------- #
_C.PRUNING = CfgNode()
_C.PRUNING.LAMDA_ALIGN = 1.0
_C.PRUNING.LAMDA_MU_STD = 1.0
_C.PRUNING.LAMDA_MARGIN = 0.4
_C.PRUNING.LAMDA_SPARSE = 0.1
_C.PRUNING.THRESHOLD = 0.04
_C.PRUNING.RATE = 0.20
